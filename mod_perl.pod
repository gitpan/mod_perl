...
variables/structures through the Apache core config gears.    Most of the configurations
directives can be represented as C<$Scalars> or C<@Lists>.  A C<@List>
inside these sections is simply converted into a single-space
...
As of apache 1.2b11, adding -DUSE_PERL_SSI to your Configuration's
EXTRA_CFLAGS will enable mod_include handling of Perl callbacks.
